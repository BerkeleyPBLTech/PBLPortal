(function ($) {
	...
	var json = [[["Sean Lee", "Stephanie Chen", "Eliot Hsu", "Yichu Chen"], ["Taylor Wang", "Jacqueline Zhang", "Samantha Sujo", "Michael Hsiu"], ["Hermes Ip", "Leona Chen", "Julian Tedja", "Ravi Siripuram"], ["Emeri Zhang", "Adam Liu", "Lily Zheng", "Shaylene Liao"]], [["Meejin Choi", "Bianca Al-Shamari", "Alex Park", "Annie Cui"], ["Linda Li", "Lorenzo dela Cruz", "Hyeonjo Jeong", "Anny Song"], ["Corey Gibbel", "Rafay Warsi", "Caroline Chen"], ["Sarah Shin", "Arina Yu", "Ozair Khan", "Jessica Dang"]], [["Chloe Lin", "Jeffrey Li", "Nayada (Mint) Katevetin"], ["Nancy Chen", "William Kim", "Kan Liu"], ["Samantha Fang", "Kristina Lee"], ["Kira Guo", "Anastasia Vela", "Troy Lee", "Max Wang"]], [["Bob Feng", "Anthony Chen"], ["Alexander Park", "Arnold Chan", "Claire Lee", "Austin Kim"], ["Carrington Park", "Elizabeth Pegg", "Megan Wang", "Shruti Maheshwari"], ["Sabrina Ni", "Eric Sung", "Rick Surya", "Rena Song"]], [["Tae Kim", "Kai Lun Chen"], ["Nicholas Paul", "Mi (Jackie) Hu"], ["Yusuf Yamani", "Janet Xu", "Nick Palmer"], ["Emily Jin", "Timothy Huang", "Alan Dai"]]];
